...
const uint16_t GRAY_ = 0b0100001000001000;
...
const uint16_t playerImg[] PROGMEM = {
  BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_,
  BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_,
  BACK_, BACK_, BACK_, BACK_, BACK_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, BACK_, BACK_, BACK_, BACK_, BACK_,
  BACK_, BACK_, BACK_, BACK_, BACK_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, BACK_, BACK_, BACK_, BACK_, BACK_,
  BACK_, BACK_, BACK_, BACK_, BACK_, GRAY_, GRAY_, RED__, RED__, RED__, RED__, RED__, RED__, RED__, GRAY_, GRAY_, BACK_, BACK_, BACK_, BACK_, BACK_,
  BACK_, BACK_, BACK_, BACK_, BACK_, GRAY_, GRAY_, RED__, RED__, RED__, RED__, RED__, RED__, RED__, GRAY_, GRAY_, BACK_, BACK_, BACK_, BACK_, BACK_,
  BACK_, BACK_, BACK_, BACK_, BACK_, GRAY_, GRAY_, RED__, RED__, BLACK, BLACK, BLACK, RED__, RED__, GRAY_, GRAY_, BACK_, BACK_, BACK_, BACK_, BACK_,
  BACK_, BACK_, BACK_, BACK_, BACK_, GRAY_, GRAY_, RED__, RED__, BLACK, BLACK, BLACK, RED__, RED__, GRAY_, GRAY_, BACK_, BACK_, BACK_, BACK_, BACK_,
  BACK_, BACK_, BACK_, BACK_, BACK_, GRAY_, GRAY_, RED__, RED__, BLACK, BLACK, BLACK, RED__, RED__, GRAY_, GRAY_, BACK_, BACK_, BACK_, BACK_, BACK_,
  BACK_, BACK_, BACK_, BACK_, BACK_, GRAY_, GRAY_, RED__, RED__, RED__, RED__, RED__, RED__, RED__, GRAY_, GRAY_, BACK_, BACK_, BACK_, BACK_, BACK_,
  BACK_, BACK_, BACK_, BACK_, BACK_, GRAY_, GRAY_, RED__, RED__, RED__, RED__, RED__, RED__, RED__, GRAY_, GRAY_, BACK_, BACK_, BACK_, BACK_, BACK_,
  BACK_, BACK_, BACK_, BACK_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, BACK_, BACK_, BACK_, BACK_,
  BACK_, BACK_, BACK_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, BACK_, BACK_, BACK_,
  BACK_, BACK_, GRAY_, GRAY_, BACK_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, BACK_, GRAY_, GRAY_, BACK_, BACK_,
  BACK_, BACK_, GRAY_, GRAY_, BACK_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, BACK_, GRAY_, GRAY_, BACK_, BACK_,
  BACK_, BACK_, GRAY_, BACK_, BACK_, BACK_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, BACK_, BACK_, BACK_, GRAY_, BACK_, BACK_,
  BACK_, GRAY_, GRAY_, GRAY_, BACK_, BACK_, BACK_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, BACK_, BACK_, BACK_, GRAY_, GRAY_, GRAY_, BACK_,
  BACK_, GRAY_, GRAY_, GRAY_, BACK_, BACK_, BACK_, YELOW, ORNGE, RED__, RED__, RED__, ORNGE, YELOW, BACK_, BACK_, BACK_, GRAY_, BACK_, GRAY_, BACK_,
  BACK_, GRAY_, BACK_, GRAY_, BACK_, BACK_, BACK_, ORNGE, YELOW, ORNGE, RED__, ORNGE, ORNGE, BACK_, BACK_, BACK_, BACK_, GRAY_, BACK_, GRAY_, BACK_,
  BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, YELOW, YELOW, ORNGE, YELOW, ORNGE, YELOW, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_,
  BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_,
};

const uint16_t playerAttackingImg[] PROGMEM {
  BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, 
  BACK_, BACK_, RED__, RED__, RED__, RED__, RED__, RED__, RED__, RED__, RED__, RED__, RED__, RED__, RED__, RED__, RED__, RED__, RED__, BACK_, BACK_, 
  BACK_, RED__, BACK_, ORNGE, ORNGE, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, ORNGE, ORNGE, BACK_, RED__, BACK_,
  BACK_, RED__, ORNGE, ORNGE, YELOW, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, YELOW, ORNGE, ORNGE, RED__, BACK_,
  BACK_, RED__, ORNGE, YELOW, YELOW, GRAY_, GRAY_, RED__, RED__, RED__, RED__, RED__, RED__, RED__, GRAY_, GRAY_, YELOW, YELOW, ORNGE, RED__, BACK_,
  BACK_, GRAY_, ORNGE, GRAY_, BACK_, GRAY_, GRAY_, RED__, RED__, RED__, RED__, RED__, RED__, RED__, GRAY_, GRAY_, BACK_, GRAY_, ORNGE, GRAY_, BACK_,
  BACK_, GRAY_, ORNGE, GRAY_, BACK_, GRAY_, GRAY_, RED__, RED__, BLACK, BLACK, BLACK, RED__, RED__, GRAY_, GRAY_, BACK_, GRAY_, ORNGE, GRAY_, BACK_,
  BACK_, GRAY_, GRAY_, GRAY_, BACK_, GRAY_, GRAY_, RED__, RED__, BLACK, BLACK, BLACK, RED__, RED__, GRAY_, GRAY_, BACK_, GRAY_, GRAY_, GRAY_, BACK_,
  BACK_, RED__, GRAY_, YELOW, BACK_, GRAY_, GRAY_, RED__, RED__, BLACK, BLACK, BLACK, RED__, RED__, GRAY_, GRAY_, BACK_, YELOW, GRAY_, RED__, BACK_,
  BACK_, RED__, GRAY_, YELOW, BACK_, GRAY_, GRAY_, RED__, RED__, RED__, RED__, RED__, RED__, RED__, GRAY_, GRAY_, BACK_, YELOW, GRAY_, RED__, BACK_,
  BACK_, RED__, GRAY_, GRAY_, BACK_, GRAY_, GRAY_, RED__, RED__, RED__, RED__, RED__, RED__, RED__, GRAY_, GRAY_, BACK_, GRAY_, GRAY_, RED__, BACK_,
  BACK_, RED__, ORNGE, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, ORNGE, RED__, BACK_,
  BACK_, RED__, ORNGE, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, ORNGE, RED__, BACK_,
  BACK_, RED__, ORNGE, YELOW, BACK_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, BACK_, YELOW, ORNGE, RED__, BACK_,
  BACK_, RED__, ORNGE, YELOW, BACK_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, BACK_, YELOW, ORNGE, RED__, BACK_,
  BACK_, RED__, ORNGE, YELOW, BACK_, BACK_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, BACK_, BACK_, YELOW, ORNGE, RED__, BACK_,
  BACK_, RED__, ORNGE, YELOW, YELOW, BACK_, BACK_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, GRAY_, BACK_, BACK_, YELOW, YELOW, ORNGE, RED__, BACK_,
  BACK_, RED__, ORNGE, ORNGE, YELOW, YELOW, YELOW, YELOW, YELOW, YELOW, YELOW, YELOW, YELOW, YELOW, YELOW, YELOW, YELOW, ORNGE, ORNGE, RED__, BACK_,
  BACK_, RED__, BACK_, ORNGE, ORNGE, ORNGE, ORNGE, ORNGE, ORNGE, ORNGE, ORNGE, ORNGE, ORNGE, ORNGE, ORNGE, ORNGE, ORNGE, ORNGE, BACK_, RED__, BACK_,
  BACK_, BACK_, RED__, RED__, RED__, RED__, RED__, RED__, RED__, RED__, RED__, RED__, RED__, RED__, RED__, RED__, RED__, RED__, RED__, BACK_, BACK_,
  BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_, BACK_,
};
...
void game() {
  ...
  for (Projectile& proj : projs) {
    ...
    if(proj.distanceTo(player) <= (player.height / 2) + projCollisionRadius) {
      proj.clear();
      player.takeDamage(1);
      if (player.health == 0) {
        level = 0;
